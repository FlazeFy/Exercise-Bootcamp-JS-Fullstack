    ...
    return (
        <div className='text-center'>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 min-h-[60vh] text-white mt-10'>
                <div className='flex flex-col justify-center bg-cover rounded-l-4xl p-10 md:p-15 lg:p-20' style={{backgroundImage:"linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('/sample/service_1.png')"}}>
                ...
                <div className='flex flex-col justify-center bg-cover rounded-r-4xl p-10 md:p-15 lg:p-20' style={{backgroundImage:"linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('/sample/service_2.png')"}}>
