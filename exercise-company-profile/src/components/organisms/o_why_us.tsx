            ...
            <div className='flex flex-wrap mt-10'>
                {
                    whyUsItem.map((dt,idx) => (
                        <div key={idx} className="w-full sm:w-1/2 lg:w-1/3 mx-auto p-5">
                            <div className='bg-white text-center mb-5 shadow-xl rounded-2xl p-5 pt-10 min-h-35 flex flex-col justify-center'>
                                <div className='rounded-full object-cover -mt-15 border-4 mb-3 p-5 text-white shadow-md mx-auto bg-primary'>
