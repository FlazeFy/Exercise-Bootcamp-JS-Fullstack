...
// Nomor 4
console.log('Nomor 4');
const unformatNum1 = 1000;
const numString = unformatNum1.toString();
let formatIDR = '';
let counter = 0;
...
// Nomor 5
console.log('Nomor 5');
const sampletring5 = "Hello world";
const findChar = "ell";
...
// Nomor 6
console.log('Nomor 6');
const sampletring6 = "hello world";
let capitalized = "";
let newWord = true;
...
// Nomor 7
console.log('Nomor 7');
const sampletring7 = "The QuiCk BrOwN Fox";
let swap = "";
for (let i = 0; i < sampletring7.length; i++) {
    const char = sampletring7[i];
